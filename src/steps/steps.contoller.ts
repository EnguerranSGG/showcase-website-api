...
export class StepsController {
  ...
  create(@Body() dto: CreateStepDto, @Req() req: any) {
  ...
  update(@Param('id') id: number, @Body() dto: UpdateStepDto, @Req() req: any) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Liste des étapes récupérée avec succès.',
  })
  getAll() {
