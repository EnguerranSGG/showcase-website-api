...
async function main() {
  ...
  const jobs = [
    ...
    {
      function: 'Coordinatrice démarche qualité',
      position_id: 1,
      created_at: now,
      updated_at: now,
      user_id: admin.user_id,
    ...
    {
      function: 'Coordinatrice référente handicape',
      position_id: 2,
      created_at: now,
      updated_at: now,
      user_id: admin.user_id,
    ...
    {
      function: 'Chefs de service (HUDA, CPH, CADA)',
      position_id: 2,
      created_at: now,
      updated_at: now,
      user_id: admin.user_id,
    ...
    {
      function: 'Référente boutique solidaire',
      position_id: 2,
      created_at: now,
      updated_at: now,
      user_id: admin.user_id,
  ...
  console.log('Jobs insérées avec succès.');
