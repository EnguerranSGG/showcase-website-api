import {
  ...
  export class JobOffersController {
    ...
    @ApiResponse({ status: 200, description: 'Offre de poste mise à jour avec succès.' })
    ...
    @ApiParam({ name: 'id', type: Number })
    @ApiResponse({ status: 200, description: 'Offre de poste supprimée avec succès.' })
    @ApiResponse({ status: 404, description: 'Offre de poste non trouvée.' })
    ...
    @ApiParam({ name: 'id', type: Number })
    @ApiResponse({ status: 200, description: 'Offre de poste récupérée avec succès.' })
    @ApiResponse({ status: 404, description: 'Offre de poste non trouvée.' })
